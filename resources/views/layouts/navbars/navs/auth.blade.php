        ...
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="dropdown nav-item">
                    ...
                    </ul><hr class="d-block d-md-none d-lg-none" style="border: 1px solid black">
                    ...
                    <ul class="nav">
                        ...
                        <li @if ($pageSlug == 'plans') class="active " @endif>
                            <a href="{{ route('pages.plans') }}">
                                ...
                                <p  style="color:black">{{ __('Plans') }}</p>
                            </a>
                        </li>
                        @endif         
                    </ul>
                    ...
                    <!-- <ul class="nav d-block d-md-none card-body">
